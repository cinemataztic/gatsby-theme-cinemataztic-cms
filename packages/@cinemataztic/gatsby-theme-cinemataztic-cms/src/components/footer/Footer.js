...
const LinkItem = ({ link }) => {
  ...
  return (
    <li {...bind()} ref={itemRef} className="pointer w-100 mt-2 mb-2 position-relative" style={{}}>
...
const Footer = () => {
  ...
  return (
    <StaticQuery
      ...
      `}
      render={(data) => {
        const { html, description, headline, footerColumn } = data.footerYaml

        const { facebookLink, instagramLink, linkedinLink } = data.metaYaml

        const { companyName } = data.generalYaml
        ...
        const columns = content.map((column, index) => {
          ...
          return (
            <div key={index} className={`${colSize} col-12 col-sm-6 pt-0 pt-md-4 pl-4  ${padLeft}`}>
              <h6 className="text-uppercase font-weight-bold">{column.columnTitle}</h6>
        ...
        columns.push(
          <div key="conta_ct" className={`col-12 col-md-3 pt-0 pt-md-4 justify-content-end pl-4 pr-2 `}>
            <div
                ...
                >
                  <div className="row " style={{}}>
                    ...
                    <div className="col-12 pl-4 pl-md-5  mx-auto">
                      <div className="" style={{}}>
                        <h1 className="font-weight-bold display-4 mt-3">{headline}</h1>
                        <Divider></Divider>
                  ...
                  <div className="row mt-4 mb-5 justify-content-between" style={{}}>
                    {columns}
                  </div>
                </div>

                <div className="col-12 col-md-10 mx-auto" style={{ background: 'black' }}>
                  <div className="row" style={{}}>
                    <div className="col-6">
                      <div className=" pt-3 pl-4 pb-3 float">
                        <p className="mb-0 font-weight-light" style={{ fontSize: '.8rem', opacity: 0.5 }}>
                    ...
                    <div className="col-6">
                      <div className="d-flex social float-right pt-1" style={{ opacity: 0.6 }}>
                        {instagramLink && (
                          <div className="pointer">
                            <a href={instagramLink} alt="instagram" target="_blank" rel="noopener noreferrer">
                              <Instagram />
                            </a>
                          </div>
                        )}
                        ...
                        {facebookLink && (
                          <div className="pointer">
                            <a href={facebookLink} alt="facebook" target="_blank" rel="noopener noreferrer">
                              <Facebook />
                            </a>
                          </div>
                        )}
                        ...
                        {linkedinLink && (
                          <div className="pointer">
                            <a href={linkedinLink} alt="linkedIn" target="_blank" rel="noopener noreferrer">
                              <LinkedIn />
                            </a>
                          </div>
                        )}
